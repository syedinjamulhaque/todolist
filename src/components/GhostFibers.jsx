...
void main() {
  ...
  /* Warmer near-black backdrop (slight brown/amber undertone) instead of purple-black */
  vec3 backdrop = mix(vec3(0.06, 0.04, 0.03), vec3(1.0), step(0.5, uLightMode));
...
const GhostFibers = ({
  /* Warm lantern-orange defaults instead of the original blue/purple */
  lineColor = '#E8590C',
  glowColor = '#FFB347',
  speed = 0.2,
  scale = 2,
  ...
  glowIntensity = 1.6,
  brightness = 2,
  /* blueBoost defaulted to 1 so it doesn't push orange back toward purple/blue */
  blueBoost = 1,
  vignette = 0.8,
  grain = 0.05,
  lightMode = false,
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uGrain: { value: 0.05 },
        uLightMode: { value: 0 },
        uLineColor: { value: new Float32Array(hexToRgb('#E8590C')) },
        uGlowColor: { value: new Float32Array(hexToRgb('#FFB347')) }
      }
    });
